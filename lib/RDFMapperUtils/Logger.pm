...
B<Description:> Instantiate RDFMapperUtils::Logger object

B<Parameters:> 

 %args

B<Returns:> Returns a reference to RDFMapperUtils::Logger
...
sub _initConfiguration {
    ...
    my $conf = q(
    log4perl.logger                    = sub {return RDFMapperUtils::Logger::_getLogLevel();}

    log4perl.appender.Logfile          = Log::Log4perl::Appender::File
    log4perl.appender.Logfile.filename = sub { return RDFMapperUtils::Logger::_getLogfile(); }
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new RDFMapperUtils::Logger(@_);

        if (!defined($instance)){
            confess "Could not instantiate RDFMapperUtils::Logger";
        }
    }
...
B<Description:> RDFMapperUtils::Logger class destructor
...
=head1 SYNOPSIS
 ...
 my $obj = RDFMapperUtils::Logger::getInstance();
