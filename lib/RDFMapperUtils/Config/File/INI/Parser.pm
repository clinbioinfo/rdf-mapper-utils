package RDFMapperUtils::Config::File::INI::Parser;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new RDFMapperUtils::Config::File::INI::Parser(@_);
...
=head1 NAME
 ...
 RDFMapperUtils::Config::File::INI::Parser
...
=head1 SYNOPSIS
 ...
 my $parser = RDFMapperUtils::Config::File::INI::Parser(masterConfigFile=>$file);
